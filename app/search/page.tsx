...
export default function SearchPage() {
  ...
  useEffect(() => {
    ...
    // Filter out outfits that have no images, similar to gallery page
  ...
  }, []); // Depend on favoriteIds or a mechanism to detect changes
